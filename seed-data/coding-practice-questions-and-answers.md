# Coding Practice Seed Questions And Answers

This file follows the same language order as the Coding Practice UI and uses the exact seeded question text for each language.

Important: students should type code in the website editor.
